    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          icon="Plus"
          @click="handleAdd"
          v-hasPermi="['chanhu:process_contracts_menu:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['chanhu:process_contracts_menu:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['chanhu:process_contracts_menu:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['chanhu:process_contracts_menu:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="process_contracts_menuList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['chanhu:process_contracts_menu:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['chanhu:process_contracts_menu:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
import { listProcess_contracts_menu, getProcess_contracts_menu, delProcess_contracts_menu, addProcess_contracts_menu, updateProcess_contracts_menu } from "@/api/chanhu/process_contracts_menu";
